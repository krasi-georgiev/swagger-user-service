...
type GetUsersOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*GetUsersOKBodyItems0 `json:"body,omitempty"`
}
...
func (o *GetUsersOK) WithPayload(payload []*GetUsersOKBodyItems0) *GetUsersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users o k response
func (o *GetUsersOK) SetPayload(payload []*GetUsersOKBodyItems0) {
	o.Payload = payload
}
...
func (o *GetUsersOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	payload := o.Payload
	if payload == nil {
		payload = make([]*GetUsersOKBodyItems0, 0, 50)
	}
...
/*GetUsersDefault Generic Error used for most error responses - it returns a custom code and message depending on the reply context
...
func (o *GetUsersDefault) WithPayload(payload *models.Response) *GetUsersDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users default response
func (o *GetUsersDefault) SetPayload(payload *models.Response) {
	o.Payload = payload
}
